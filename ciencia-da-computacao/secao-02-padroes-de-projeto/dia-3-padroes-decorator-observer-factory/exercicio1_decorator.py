# Em Python, é possível imprimir uma saída colorida. Para isso, basta a string
# começar com um código da cor antes e terminar com um código que indica o fim
# da formatação. A cor será diferente dependendo da configuração do seu pc.
