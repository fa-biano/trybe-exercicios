...
# impostos e precisa ser refatorado para adicionar novos, que no caso
# são o PIS (0,65%) e o COFINS (3%). Mas durante a refatoração, você se
# depara com uma má prática de código. Encontre essa má prática e a
