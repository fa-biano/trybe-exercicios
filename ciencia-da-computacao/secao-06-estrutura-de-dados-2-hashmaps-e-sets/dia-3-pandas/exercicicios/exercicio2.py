...
# Se você fizer um print aqui, verá que as linhas na coluna "population_share"
# estarão marcadas como True ou False, que são referentes à comparação entre a
# porcentagem do país e o valor "> 2"
